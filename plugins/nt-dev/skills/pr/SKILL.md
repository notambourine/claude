...
**Budget the whole body at 150 words**, whichever template you landed on. The house copy says so in its own comments and allocates the 150 across its sections; a repo's own template usually says nothing, and the budget applies there too. 150 is a ceiling, not a target - scale the body to the diff, so a one-file change lands in two sentences. Past 150 words you are writing the diff back. Cut prose first, never a screenshot and never a `_none_`.
